...
class MyWidget : AppWidgetProvider() {
    ...
    private fun updateAppWidget(
        ...
        //lauch a pending intent to increase the value saved in shared preferences
        views.setOnClickPendingIntent(R.id.buttonClickMe, pendingIntent(context, "increase"))
